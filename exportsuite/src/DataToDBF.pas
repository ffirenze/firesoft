...
uses
  ...
  {$IFNDEF MORE180}, AnsiStrings{$ENDIF}
...
begin
  ...
  if {$IFDEF MORE210}FormatSettings.{$ENDIF}DecimalSeparator <> DBF_DECIMAL_SEPARATOR then
  begin
    PFindChar := StrScan(ADest, {$IFDEF MORE210}FormatSettings.{$ENDIF}DecimalSeparator);
